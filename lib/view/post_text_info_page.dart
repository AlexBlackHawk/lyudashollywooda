...
class PostInfoPage extends StatefulWidget {
  const PostInfoPage({super.key, required this.userId, required this.userInfo, required this.postId, required this.productList});
                            ...
                            children: [
                              data["image"] != "" ? Stack(
                                children: [
                                  ...
                                  //               PersistentNavBarNavigator.pushNewScreen(
                                  //                 context,
                                  //                 screen: DonatePage(userInfo: userInfo, userId: userId,),
                                  //                 withNavBar: true,
                                  //               );
                                  //               // Navigator.of(context).push(
                                  //               //   MaterialPageRoute(
